...
export default function KondisiHamaTable(props) {
    ...
    return (
        <div className="flex flex-col">
            ...
            <Grid
                server={{
                    url: url + "kondisihama-data",
                    then: (data) =>
                        data.map((kondisihama, index) => [
                            "G" + (index + 1),
                            kondisihama.name,
                            _(
                                <button
                                    onClick={() => {
                                        setEditData(kondisihama);
                                        setShowModal(true);
                                    }}
                ...
                columns={["Kode Kondisi", "Kondisi", "Edit", "Hapus"]}
                search={true}
                pagination={{
                    enabled: true,
                    limit: 10,
